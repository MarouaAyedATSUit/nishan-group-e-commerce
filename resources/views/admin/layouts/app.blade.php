...
<head>
    <title>Admin Nishan Group E Commerce</title>
    <meta charset="utf-8" />
...
<!--end::Page Vendor Stylesheets-->
    ...
    <link href="{{ asset('assets/css/customize_style.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div class="app-header">
                <!-- Header content -->
                @include('admin.includes.light-header')
            </div>
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper flex-row flex-row-fluid" id="kt_app_wrapper">
                ...
                <div class="app-sidebar">
                    @include('admin.includes.light-sidebar')
                </div>
                <!--end::Sidebar-->
            </div>
            <!--end::Wrapper-->
