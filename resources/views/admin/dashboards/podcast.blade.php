                    ...
                    <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                                style="background-color:#020202;background-image:url('assets/media/stock/600x600/img-62.jpg')">
                                <!--begin::Body-->
                            ...
                            <div class="card card-flush h-xl-100" id="kt_player_widget_2">
                                ...
                                <div class="card-body bg-black pt-0">
                                    ...
                                    <div class="mx-auto mb-6 bgi-no-repeat bgi-size-contain bgi-position-center rounded-circle w-125px h-125px"
                                        style="background-image:url('assets/media/stock/600x600/img-59.jpg')"></div>
                                    <!--end::Image-->
                                    <!--begin::Section-->
                                ...
                                <div class="card-footer bg-primary p-0 pb-9">
                                    <div class="mt-n10">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <!--end::Time-->
                                            <input type="range" class="form-range" data-kt-element="progress"
                                        ...
                                        <div class="d-flex flex-center">
                                            ...
                                            <button class="btn btn-icon mx-6 play-pause" data-kt-element="play-button">
                                                <i class="bi bi-play-fill text-white fs-4x"
                                                    data-kt-element="play-icon"></i>
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        Podcast</a>
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Darlene
                                                        Robertson</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        Lights</a>
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Wade
                                                        Warren</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        ...
                                        <div class="col-sm-3 mb-3 mb-sm-0">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Jacob
                                                        Jones</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        ...
                                        <div class="col-sm-3 mb-3 mb-sm-0">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="card-rounded position-relative mb-5">
                                                    <!--begin::Img-->
                                                    <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                        style="background-image:url('assets/media/stock/600x600/img-57.jpg')">
                                                    </div>
                                                    <!--end::Img-->
                                                    <!--begin::Play-->
                                                    <button
                                                ...
                                                <div class="m-0">
                                                    <!--begin::Title-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">It
                                                        is what it is</a>
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Jane
                                                        Cooper</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        ...
                                        <div class="col-sm-3 mb-3 mb-sm-0">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="card-rounded position-relative mb-5">
                                                    <!--begin::Img-->
                                                    <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                        style="background-image:url('assets/media/stock/600x600/img-58.jpg')">
                                                    </div>
                                                    <!--end::Img-->
                                                    <!--begin::Play-->
                                                    <button
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        Mirros</a>
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Jenny
                                                        Wilson</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        ...
                                        <div class="col-sm-3 mb-3 mb-sm-0">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="card-rounded position-relative mb-5">
                                                    <!--begin::Img-->
                                                    <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                        style="background-image:url('assets/media/stock/600x600/img-55.jpg')">
                                                    </div>
                                                    <!--end::Img-->
                                                    <!--begin::Play-->
                                                    <button
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        Hood</a>
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Albert
                                                        Flores</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="card-rounded position-relative mb-5">
                                                    <!--begin::Img-->
                                                    <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                        style="background-image:url('assets/media/stock/600x600/img-64.jpg')">
                                                    </div>
                                                    <!--end::Img-->
                                                    <!--begin::Play-->
                                                    <button
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        Lights</a>
                                                    <!--end::Title-->
                                                    <span class="fw-bold fs-6 text-gray-500 d-block lh-1">Dianne
                                                        Russell</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                ...
                                <div class="card-body pt-6">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <div class="flex-grow-1 me-2">
                                                <a href="pages/user-profile/overview.html"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bolder">Leslie
                                                    Alexander</a>
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <div class="flex-grow-1 me-2">
                                                <a href="pages/user-profile/overview.html"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bolder">Ronald
                                                    Richards</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                            </div>
                                            <!--end:Author-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <div class="flex-grow-1 me-2">
                                                <a href="pages/user-profile/overview.html"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bolder">Courtney
                                                    Henry</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                            </div>
                                            <!--end:Author-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <div class="flex-grow-1 me-2">
                                                <a href="pages/user-profile/overview.html"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bolder">Arlene
                                                    McCoy</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                            </div>
                                            <!--end:Author-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <div class="flex-grow-1 me-2">
                                                <a href="pages/user-profile/overview.html"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bolder">Marvin
                                                    McKinney</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                            </div>
                                            <!--end:Author-->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <span
                                                            class="text-gray-500 fw-semibold d-block fs-7">Earnings</span>
                                                    </td>
                                                    <td class="float-end text-end border-0">
                                                        ...
                                                        <span
                                                            class="text-gray-500 fw-semibold d-block fs-7 mt-1">Rating</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="#"
                                                ...
                                                <table class="table align-middle gs-0 gy-4">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <a href="#"
                                                                    class="text-gray-600 fw-bold fs-6">Donates</a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#"
                                                                    class="text-gray-600 fw-bold fs-6">Podcasts</a>
                                                            </td>
                                                            <td class="pe-0 text-end">
                                                                <span
                                                                    class="text-gray-800 fw-bold fs-6 me-1">$2,207.03</span>
                                                            </td>
                                                            <td class="pe-0 text-end">
                                                ...
                                                <table class="table align-middle gs-0 gy-4">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="pe-0 text-end">
                                                                <span
                                                                    class="text-gray-800 fw-bold fs-6 me-1">$1,656.26</span>
                                                            </td>
                                                            <td class="pe-0 text-end">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pe-0 text-end">
                                                                <span
                                                                    class="text-gray-800 fw-bold fs-6 me-1">$2,865.25</span>
                                                            </td>
                                                            <td class="pe-0 text-end">
                                                ...
                                                <table class="table align-middle gs-0 gy-4">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="pe-0 text-end">
                                                                <span
                                                                    class="text-gray-800 fw-bold fs-6 me-1">$2,925.45</span>
                                                            </td>
                                                            <td class="pe-0 text-end">
                                                ...
                                                <table class="table align-middle gs-0 gy-4">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="pe-0 text-end">
                                                                <span
                                                                    class="text-gray-800 fw-bold fs-6 me-1">$856.26</span>
                                                            </td>
                                                            <td class="pe-0 text-end">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pe-0 text-end">
                                                                <span
                                                                    class="text-gray-800 fw-bold fs-6 me-1">$2,556.26</span>
                                                            </td>
                                                            <td class="pe-0 text-end">
