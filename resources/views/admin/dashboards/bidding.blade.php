                                        ...
                                        <div class="col-sm-6 mb-10 mb-sm-0">
                                            ...
                                            <a class="d-block overlay h-100" data-fslightbox="lightbox-hot-sales"
                                                ...
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-200px h-100"
                                                    style="background-image:url('assets/media/stock/600x600/img-42.jpg')">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                ...
                                                <div class="mb-7">
                                                    <!--begin::Title-->
                                                    <div class="mb-6">
                                                        <span class="text-gray-500 fs-7 fw-bold me-2 d-block lh-1 pb-1">NFT
                                                            ID: 34356776</span>
                                                        <a href="apps/projects/users.html"
                                                            class="text-gray-800 text-hover-primary fs-1 fw-bold">California
                                                            Art</a>
                                                    </div>
                                                    <!--end::Title-->
                                                    <!--begin::Items-->
                                                    <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                        ...
                                                        <div class="d-flex align-items-center me-5 me-xl-13">
                                                            ...
                                                            <div class="m-0">
                                                                <span
                                                                    class="fw-semibold text-gray-500 d-block fs-8">Creator</span>
                                                                <a href="apps/projects/users.html"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="m-0">
                                                                <span class="fw-semibold text-gray-500 d-block fs-8">Instant
                                                                    Price</span>
                                                                <a href="#"
                                                                    class="fw-bold text-gray-800 text-hover-primary fs-7">4.2
                                                                    ETH</a>
                                                            </div>
                                                            <!--end::Info-->
                                                        </div>
                                                ...
                                                <div class="d-flex flex-stack mt-auto bd-highlight">
                                                    ...
                                                    <a href="#" class="btn btn-primary btn-sm flex-shrink-0 me-3"
                                                        data-bs-toggle="modal" data-bs-target="#kt_modal_bidding">Place a
                                                        Bid</a>
                                                    <a href="#" class="btn btn-light btn-sm flex-shrink-0"
                                                        data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">View
                                                        Item</a>
                                                    <!--end::Actions-->
                                                </div>
                                                <!--end::Footer-->
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-body text-center pb-5">
                                    ...
                                    <div class="d-flex align-items-end flex-stack mb-1">
                                        ...
                                        <div class="text-start">
                                            <span
                                                class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Wavy
                                                Curved Art</span>
                                ...
                                <div class="card-footer d-flex flex-stack pt-0">
                                    ...
                                    <a class="btn btn-sm btn-primary flex-shrink-0 me-2"
                                        data-bs-target="#kt_modal_bidding" data-bs-toggle="modal">Place a Bid</a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-body text-center pb-5">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        ...
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                            style="height: 266px;background-image:url('assets/media/stock/600x600/img-47.jpg">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    ...
                                    <div class="d-flex align-items-end flex-stack mb-1">
                                        ...
                                        <div class="text-start">
                                            <span
                                                class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Happy
                                                Kitty Art</span>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td class="pe-0">
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            <div class="symbol symbol-30px me-3">
                                                                <img src="assets/media/avatars/300-13.jpg" class=""
                                                                    alt="" />
                                                            </div>
                                                            <span class="text-gray-600 fw-bold d-block fs-6">0.089
                                                                ETH</span>
                                                        </div>
                                                    </td>
                                                    <td class="text-end pe-0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="symbol symbol-50px me-3">
                                                                <img src="assets/media/stock/600x600/img-43.jpg"
                                                                    class="" alt="" />
                                                            </div>
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="#"
                                                    ...
                                                    <td class="pe-0">
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <span class="text-gray-600 fw-bold d-block fs-6">3.083
                                                                ETH</span>
                                                        </div>
                                                    </td>
                                                    <td class="text-end pe-0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="symbol symbol-50px me-3">
                                                                <img src="assets/media/stock/600x600/img-46.jpg"
                                                                    class="" alt="" />
                                                            </div>
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="#"
                                                    ...
                                                    <td class="pe-0">
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <span class="text-gray-600 fw-bold d-block fs-6">1.058
                                                                ETH</span>
                                                        </div>
                                                    </td>
                                                    <td class="text-end pe-0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="symbol symbol-50px me-3">
                                                                <img src="assets/media/stock/600x600/img-54.jpg"
                                                                    class="" alt="" />
                                                            </div>
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="#"
                                                    ...
                                                    <td class="pe-0">
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <span class="text-gray-600 fw-bold d-block fs-6">0.403
                                                                ETH</span>
                                                        </div>
                                                    </td>
                                                    <td class="text-end pe-0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="symbol symbol-50px me-3">
                                                                <img src="assets/media/stock/600x600/img-45.jpg"
                                                                    class="" alt="" />
                                                            </div>
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="#"
                                                    ...
                                                    <td class="pe-0">
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <span class="text-gray-600 fw-bold d-block fs-6">1.094
                                                                ETH</span>
                                                        </div>
                                                    </td>
                                                    <td class="text-end pe-0">
