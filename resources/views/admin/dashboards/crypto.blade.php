                                    ...
                                    <div class="card card-flush h-xl-100" style="background-color: #F6E5CA">
                                        ...
                                        <div class="card-header flex-nowrap pt-5">
                                            ...
                                            <h3 class="card-title align-items-start flex-column">
                                                ...
                                                <span class="mt-1 fw-semibold fs-7" style="color:">36,668 USD for 1
                                                    BTC</span>
                                            </h3>
                                            <!--end::Title-->
                                            <!--begin::Toolbar-->
                                            <div class="card-toolbar">
                                                <!--begin::Menu-->
                                                <button class="btn btn-icon justify-content-end"
                                                    data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                                                    data-kt-menu-overflow="true" style="color:">
                                    ...
                                    <div class="card card-flush h-xl-100" style="background-color: #F3D6EF">
                                        ...
                                        <div class="card-header flex-nowrap pt-5">
                                            ...
                                            <h3 class="card-title align-items-start flex-column">
                                                ...
                                                <span class="mt-1 fw-semibold fs-7" style="color:">325,035 USD for 1
                                                    ETH</span>
                                            </h3>
                                            <!--end::Title-->
                                            <!--begin::Toolbar-->
                                    ...
                                    <div class="card card-flush h-xl-100" style="background-color: #BFDDE3">
                                        ...
                                        <div class="card-header flex-nowrap pt-5">
                                            ...
                                            <h3 class="card-title align-items-start flex-column">
                                                ...
                                                <span class="mt-1 fw-semibold fs-7" style="color:">0.12,045 USD for 1
                                                    DOGE</span>
                                            </h3>
                                            <!--end::Title-->
                                            <!--begin::Toolbar-->
                                ...
                                <div class="card-header position-relative min-h-50px p-0 border-bottom-2">
                                    ...
                                    <ul class="nav nav-pills nav-pills-custom d-flex position-relative w-100">
                                        ...
                                        <li class="nav-item mx-0 px-0 w-50">
                                            <!--begin::Link-->
                                            <a class="nav-link btn btn-color-muted border-0 h-100 px-0"
                                                data-bs-toggle="pill" id="kt_forms_widget_1_tab_2"
                                        ...
                                        <div class="tab-pane fade active show" id="kt_forms_widget_1_tab_content_1">
                                            ...
                                            <div class="form-floating border border-gray-300 rounded mb-7">
                                                <select class="form-select form-select-transparent"
                                                    ...
                                                    <option value="4"
                                                        data-kt-select2-icon="assets/media/svg/coins/binance.svg">
                                                        Binance/BCN</option>
                                                </select>
                                            ...
                                            <div class="row mb-7">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="email" class="form-control text-gray-800 fw-bold"
                                                            placeholder="00.0" id="floatingInputValue"
                                                            value="$0,00000032" />
                            ...
                            <div class="card h-md-100" dir="ltr">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="text-center mb-1">
                                        ...
                                        <!--end::Link-->
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-light" href="apps/ecommerce/sales/listing.html">Learn
                                            More</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary fs-6">GPUs mining</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                            ...
                                            <div class="d-flex flex-center">
                                                ...
                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                    <input class="form-check-input h-20px w-30px" type="checkbox"
                                                        value="" id="flexSwitchChecked" checked="checked" />
                                                </div>
                                                <!--end::Action-->
                                            </div>
                                            <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary fs-6">Est. daily
                                                    USD</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary fs-6">Team Members</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
