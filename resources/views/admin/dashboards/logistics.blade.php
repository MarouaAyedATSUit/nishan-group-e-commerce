            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="apps/customers/list.html" class="btn btn-sm fw-bold btn-secondary">Add Customer</a>
                        <!--end::Secondary button-->
                        <!--begin::Primary button-->
                        <a href="apps/ecommerce/sales/add-order.html" class="btn btn-sm fw-bold btn-primary">New
                            Shipment</a>
                        <!--end::Primary button-->
                    </div>
                    <!--end::Actions-->
                            ...
                            <div class="card h-md-100" dir="ltr">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="text-center mb-1">
                                        ...
                                        <!--end::Link-->
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-light" href="apps/invoices/view/invoice-2.html">Quick
                                            Guide</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="d-flex flex-column content-justify-center flex-grow-1">
                                                    ...
                                                    <div class="d-flex fs-6 fw-semibold align-items-center">
                                                        ...
                                                        <!--end::Bullet-->
                                                        <!--begin::Label-->
                                                        <div class="fs-6 fw-semibold text-gray-500 flex-shrink-0">Used Truck
                                                            freight</div>
                                                        <!--end::Label-->
                                                        <!--begin::Separator-->
                                                    ...
                                                    <div class="d-flex fs-6 fw-semibold align-items-center my-1">
                                                        ...
                                                        <!--end::Bullet-->
                                                        <!--begin::Label-->
                                                        <div class="fs-6 fw-semibold text-gray-500 flex-shrink-0">Used Ship
                                                            freight</div>
                                                        <!--end::Label-->
                                                        <!--begin::Separator-->
                                                        <div class="separator separator-dashed min-w-10px flex-grow-1 mx-2">
                                                    ...
                                                    <div class="d-flex fs-6 fw-semibold align-items-center">
                                                        ...
                                                        <!--end::Bullet-->
                                                        <!--begin::Label-->
                                                        <div class="fs-6 fw-semibold text-gray-500 flex-shrink-0">Used Plane
                                                            freight</div>
                                                        <!--end::Label-->
                                                        <!--begin::Separator-->
                                                        <div class="separator separator-dashed min-w-10px flex-grow-1 mx-2">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="d-flex align-items-sm-center mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                        <div class="flex-grow-1 me-2">
                                                            <a href="#"
                                                                class="text-gray-500 fs-6 fw-semibold">Delivery Freight</a>
                                                            <span
                                                                class="text-gray-800 fw-bold d-block fs-4">#5635-342808</span>
                                                        </div>
                                                        <span
                                                ...
                                                <div class="timeline">
                                                    ...
                                                    <div class="timeline-item align-items-center mb-7">
                                                        ...
                                                        <div class="timeline-content m-0">
                                                            <!--begin::Title-->
                                                            <span class="fs-6 text-gray-500 fw-semibold d-block">Mina St -
                                                                Zayed Port</span>
                                                            <!--end::Title-->
                                                            <!--begin::Title-->
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="d-flex align-items-sm-center mb-5">
                                                    ...
                                                    <div class="symbol symbol-45px me-4">
                                                        <span class="symbol-label bg-primary">
                                                            <i
                                                                class="ki-duotone ki-airplane-square text-inverse-primary fs-1">
                                                                <span class="path1"></span>
                                                                <span class="path2"></span>
                                                            </i>
                                                        </span>
